...
public class ManageFiles
{
    ...
    public static string ProcessedFolderPath = @"C:\\ProgramData\SpeechLive Helper\Processed\";
    ...
    public static string LogsArchiveFolderPath = @"C:\\ProgramData\SpeechLive Helper\Logs\Archive\";
    public static string ImportFolderPath = @"C:\\ProgramData\SpeechLive Helper\Import\";
